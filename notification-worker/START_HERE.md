...
```
🚀 SafeZone Marketplace Notification Worker started
📡 Monitoring /reports for marketplace items and status changes...
```

When notifications are sent, you'll see:
```
✅ [4:35:12 PM] FCM sent to category_roadHazard for listing xyz
```
